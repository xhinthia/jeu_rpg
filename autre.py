...
def tuto_detail(nom):
	...
	print (" ")
	print ("L'ensemble de vos caractéristiques augmentent en fonction de votre choix de quête.")
	print (" ")
	print ("Par exemple, si vous avez choisi la quête de la force vous gagnerez plus de force ou encore si vous avez choisi la quête de la vie vous gagnerez plus de vie.")
	print (" ")
	continuer=input("[enter]")
	print (" ")
	print (" ")
	...
	while str(tutoriel)!="1":
		print ("Essaye de taper '1' et d'appuyer sur entrée !")
		print (" ")
		print ("[1] sanguinaire")
		tutoriel=input()
	print (" ")
	...
	print (" ")
	print ("Sanguinaire est un sort très fort, il cause des dégats et vous rend de la vie !")
	print (" ")
	print ("Parfait quand on a beaucoup de PV max car la vie rendue dépend du total de PV !")
	print (" ")
	print (" ")
	...
	while str(tutoriel)!="2":
		print ("Essaye de taper '2' et d'appuyer sur entrée !")
		print (" ")
		print ("[2] devaster")
		tutoriel=input()
	print (" ")				
	...
	print (" ")
	print (" ")
	print ("Coup de bouclier permet d'effectuer des dégats en fonction de votre force et de réduire la defense de l'adversaire")
	print (" ")
	...
	while str(tutoriel)!="4":
		print ("Essaye de taper '4' et d'appuyer sur entrée !")
		print (" ")
		print ("[4] enchainement")
		tutoriel=input()
	print (" ")
	...
	print (" ")
	print ("Un sort puissant si tu as beaucoup de vitesse pour augmenter grandement ton combo !")
	print (" ")
	continuer=input("[enter]")
	print (" ")
	print (" ")
